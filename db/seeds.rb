...
Subject.create(name: "9C Science", photo: "assets/images/science3.png", user: teacher_user )
...
Appointment.create(student_id: rand(1..20), teacher: teacher_user, date: Date.new(2019,12,6))
Appointment.create(student_id: rand(1..20), teacher: teacher_user, date: Date.new(2019,12,6))
Appointment.create(student_id: rand(1..20), teacher: teacher_user, date: Date.new(2019,12,6))
Appointment.create(student_id: rand(1..20), teacher: teacher_user, date: Date.new(2019,11,23))
Appointment.create(student_id: rand(1..20), teacher: teacher_user, date: Date.new(2019,11,20))
